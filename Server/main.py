...
class Data (db.Model):
    ...
    firstAvg = db.Column("firstAvg", db.Float(precision=2, decimal_return_scale=None), unique = False, nullable = True)
    ...
    secondAvg = db.Column("secondAvg", db.Float(precision=2, decimal_return_scale=None), unique = False, nullable = True)
    ...
    thirdAvg = db.Column("thirdAvg", db.Float(precision=2, decimal_return_scale=None), unique = False, nullable = True)
